...
b=0 #  % шанс на отклонение от основоной дороги с самым большим числом феромонов

number_of_ants=100
one_start_location=False #If false then ants will sapwn in random location

pheromone_min=12.5
pheromone_max=100.0
pheromone_const=0.8 #константное значение выделяемого феромона каждым муравьём
...
elitist_const=0.9 ##константное значение выделяемого феромона элитным муравьём



if(random_distance_matrix==True):#инициализация матрицы растояний рандомными числами от 1 до 50
    mylist = []
